  ...
  py::class_<SocketReactor>(
      ...
      .def(
          ...
          [](SocketReactor &self, espp::UdpSocket &socket, std::size_t port,
             ...
             std::optional<uint8_t> dscp) -> SocketReactor::Id {
          ...
          py::arg("band") = espp::QosBand::Normal, py::arg("dscp") = std::optional<uint8_t>{},
          ...
          "selects the espp.QosBand this socket's handlers are dispatched at; `dscp` (0-63) "
          "optionally marks transmitted replies (IP_TOS, best-effort). Returns a registration id "
          "(0 == INVALID_ID on failure).")
