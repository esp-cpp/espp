...
class RangeMapper_int:  # Python specialization for RangeMapper<int>
    ...
    class Config:
        ...
        range_deadband: int = 0      #*< Deadband amount around the minimum and maximum for which output will be min/max output.
        output_center: int = 0       #*< The center for the output. Default 0.
        output_range: int = 1        #*< The range (+/-) from the center for the output. Default 1. @note Will be passed through std::abs() to ensure it is positive.
        invert_output: bool = False  #*< Whether to invert the output (default False). @note If True will flip the sign of the output after converting from the input distribution.
        def __init__(
            self,
            center: int = int(),
...
class RangeMapper_float:  # Python specialization for RangeMapper<float>
    ...
    class Config:
        ...
        range_deadband: float = 0    #*< Deadband amount around the minimum and maximum for which output will be min/max output.
        output_center: float = 0     #*< The center for the output. Default 0.
        output_range: float = 1      #*< The range (+/-) from the center for the output. Default 1. @note Will be passed through std::abs() to ensure it is positive.
        invert_output: bool = False  #*< Whether to invert the output (default False). @note If True will flip the sign of the output after converting from the input distribution.
        def __init__(
            self,
            center: float = float(),
