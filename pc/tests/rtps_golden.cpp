// Golden wire-format tests for the embeddedRTPS engine (components/rtps).
//
// Phase 0b of components/rtps/REFACTOR_PLAN.md: freeze the engine's current
...
//   ./rtps_golden --dump > ../tests/rtps_golden.inc
//
...
int main(int argc, char **argv) {
  ...
  if (argc > 1 && std::string(argv[1]) == "--dump") {
    ...
    std::printf("// Generated by: ./rtps_golden --dump > "
                "../tests/rtps_golden.inc\n");
