...
namespace espp {
  ...
  public:
    ...
    struct Config {
      ...
      OutputDriveModeP0 output_drive_mode_p0 = OutputDriveModeP0::OPEN_DRAIN; ///< Output drive mode for Port 0
     ...
     */
    void configure_global_control(OutputDriveModeP0 output_drive_mode_p0, MaxLedCurrent max_led_current) {
  ...
  protected:
    ...
    enum class ControlBit : int {
      ...
      ISEL  = 0, ///< [bits [1:0]] Set max drive current of LED (b11=imax/4, b10=imax/2, b01=imax*3/4, b00=imax, default=b00)
    };
