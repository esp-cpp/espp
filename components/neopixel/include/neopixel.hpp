...
namespace espp {
  ...
  protected:
    ...
    std::size_t encode(rmt_channel_handle_t channel, rmt_encoder_t *copy_encoder, rmt_encoder_t *bytes_encoder, const void *data, std::size_t data_size, rmt_encode_state_t *ret_state);
