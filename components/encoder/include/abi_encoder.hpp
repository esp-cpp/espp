...
namespace espp {
  ...
  public:
     ...
     */
    template <EncoderType type = T>
    typename std::enable_if<type == EncoderType::ROTATIONAL,
                            float>::type
    get_revolutions() {
      auto raw = get_count();
  ...
  protected:
    ...
    void init(const Config& config) {
      ...
      // actions
      pcnt_channel_set_edge_action(pcnt_channel_a_, PCNT_CHANNEL_EDGE_ACTION_DECREASE, PCNT_CHANNEL_EDGE_ACTION_INCREASE);
      pcnt_channel_set_level_action(pcnt_channel_a_, PCNT_CHANNEL_LEVEL_ACTION_KEEP, PCNT_CHANNEL_LEVEL_ACTION_INVERSE);
      pcnt_channel_set_edge_action(pcnt_channel_b_, PCNT_CHANNEL_EDGE_ACTION_INCREASE, PCNT_CHANNEL_EDGE_ACTION_DECREASE);
      pcnt_channel_set_level_action(pcnt_channel_b_, PCNT_CHANNEL_LEVEL_ACTION_KEEP, PCNT_CHANNEL_LEVEL_ACTION_INVERSE);
      ...
      pcnt_event_callbacks_t cbs = {
        .on_reach = &AbiEncoder::pcnt_on_reach
      };
