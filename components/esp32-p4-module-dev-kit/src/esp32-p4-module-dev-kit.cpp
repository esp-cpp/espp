...
Esp32P4ModuleDevKit::Esp32P4ModuleDevKit()
    : BaseComponent("Esp32P4ModuleDevKit") {}

bool Esp32P4ModuleDevKit::initialize_ethernet() { return initialize_ethernet(EthernetConfig{}); }

bool Esp32P4ModuleDevKit::initialize_ethernet(const EthernetConfig &config) {
