/**
 * @file esp32_p4_module_dev_kit_example.cpp
 * @brief Waveshare ESP32-P4-Module-DEV-KIT BSP example
 *
...
extern "C" void app_main(void) {
  espp::Logger logger(
      {.tag = "ESP32-P4-Module-DEV-KIT Example", .level = espp::Logger::Verbosity::INFO});
  logger.info("Starting example!");

  //! [esp32 p4 module dev kit example]
