...
///   other tasks (button callbacks, the main loop, etc.) can safely call
///   them.
///
/// For this example the Gui shows:
/// * A label with text centered on the screen
/// * A custom-drawn layer of circles which the main loop draws in a ring
///   around the center of the screen
///
/// Since this board has no touchscreen there are no on-screen buttons; the
/// hardware button cycles the display rotation via next_rotation().
class Gui {
public:
  /// The maximum number of circles which can be drawn on the screen at once
