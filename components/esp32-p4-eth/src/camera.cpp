...
bool Esp32P4Eth::initialize_camera(const camera_frame_callback_t &callback,
  ...
  camera_task_ = espp::Task::make_unique({
      .callback = std::bind(&Esp32P4Eth::camera_task_callback, this, _1, _2, _3),
...
bool Esp32P4Eth::camera_task_callback(std::mutex &m, std::condition_variable &cv,
                                      bool &task_notified) {
...
uint16_t Esp32P4Eth::camera_width() const { return camera_width_; }

uint16_t Esp32P4Eth::camera_height() const { return camera_height_; }
