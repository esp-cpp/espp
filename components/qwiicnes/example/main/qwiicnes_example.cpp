...
extern "C" void app_main(void) {
  {
    ...
    auto task_fn = [&quit_test, &qwiicnes](std::mutex &m, std::condition_variable &cv) {
      ...
      fmt::print("QwiicNes buttons:\n"
                 ...
                 "\tLeft:   {}\n"
                 "\tRight:  {}\n",
                 (bool)button_state.a, (bool)button_state.b, (bool)button_state.select,
                 (bool)button_state.start, (bool)button_state.up, (bool)button_state.down,
                 (bool)button_state.left, (bool)button_state.right);
