...
///
/// The Byte90 has no touchscreen, so there are no on-screen buttons; instead
/// the hardware button cycles the display rotation via next_rotation().
class Gui {
public:
  /// The maximum number of circles that can be drawn on the screen before
