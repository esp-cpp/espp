/**
 * @file esp32_p4_nano_example.cpp
 * @brief Waveshare ESP32-P4-NANO BSP example
 *
...
extern "C" void app_main(void) {
  espp::Logger logger({.tag = "ESP32-P4-NANO Example", .level = espp::Logger::Verbosity::INFO});
  ...
  espp::Task status_task(espp::Task::Config{
      ...
      .task_config = {.name = "p4-nano status", .stack_size_bytes = 6144}});
  status_task.start();
