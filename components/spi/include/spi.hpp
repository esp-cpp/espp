...
/// acquisition. `SpiPanelIo` builds on top of `Spi::Device` for queued
/// command/data display transports.
///
...
public:
  ...
  struct Config {
    ...
    uint32_t data_command_bit_mask = 0;       ///< User bit that selects data mode.
