...
- initializing and driving the four DC-motor channels with normalized speed
  commands, where positive commands drive `pwm_a`, negative commands drive
...
encoder polling and a slow motor sweep when you are connected to real hardware
and want to exercise the board interfaces.
