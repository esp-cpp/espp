...
void Gui::init_background() {
  auto &tdongle = espp::TDongleS3::get();
  background_ = lv_obj_create(lv_screen_active());
  lv_obj_set_size(background_, tdongle.rotated_display_width(), tdongle.rotated_display_height());
...
void Gui::init_circle_layer() {
  ...
  lv_obj_set_size(circle_layer_, tdongle.rotated_display_width(), tdongle.rotated_display_height());
