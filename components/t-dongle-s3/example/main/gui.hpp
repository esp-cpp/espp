...
/// * A custom-drawn layer of circles which the main loop animates in a ring
///
/// The T-Dongle-S3 has no touch screen, so there are no on-screen buttons;
/// the hardware button cycles the display rotation via next_rotation().
class Gui {
public:
  /// The maximum number of circles which can be visible at once
