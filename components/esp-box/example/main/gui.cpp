...
void Gui::init_background() {
  ...
  lv_obj_set_size(background_, box.lcd_width(), box.lcd_height());
...
void Gui::init_gravity_lines() {
  ...
  kalman_line_points_[1] = {box.lcd_width(), box.lcd_height()};
  ...
  madgwick_line_points_[1] = {box.lcd_width(), box.lcd_height()};
...
void Gui::init_circle_layer() {
  ...
  lv_obj_set_size(circle_layer_, box.lcd_width(), box.lcd_height());
...
void Gui::next_rotation() {
  ...
  lv_obj_set_size(background_, box.rotated_display_width(), box.rotated_display_height());
  lv_obj_set_size(circle_layer_, box.rotated_display_width(), box.rotated_display_height());
  lv_obj_align(circle_layer_, LV_ALIGN_CENTER, 0, 0);
