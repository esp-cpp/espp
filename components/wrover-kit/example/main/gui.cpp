...
void Gui::init_background() {
  auto &wrover = espp::WroverKit::get();
  background_ = lv_obj_create(lv_screen_active());
  lv_obj_set_size(background_, wrover.rotated_display_width(), wrover.rotated_display_height());
...
void Gui::init_circle_layer() {
  ...
  lv_obj_set_size(circle_layer_, wrover.rotated_display_width(), wrover.rotated_display_height());
