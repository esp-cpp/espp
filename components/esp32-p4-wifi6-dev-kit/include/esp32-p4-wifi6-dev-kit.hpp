...
/// </table>
///
/// ESP32-P4 &harr; ESP32-C6 SDIO link (ESP-Hosted; matches the esp_hosted
/// SDIO defaults for the ESP32-P4):
///
/// <table>
/// <tr><th>Signal</th><th>GPIO</th></tr>
/// <tr><td>SDIO CLK</td><td>18</td></tr>
/// <tr><td>SDIO CMD</td><td>19</td></tr>
/// <tr><td>SDIO D0</td><td>14</td></tr>
/// <tr><td>SDIO D1</td><td>15</td></tr>
/// <tr><td>SDIO D2</td><td>16</td></tr>
/// <tr><td>SDIO D3</td><td>17</td></tr>
/// <tr><td>C6 CHIP_PU (reset)</td><td>54</td></tr>
/// </table>
///
...
public:
  ...
  static constexpr gpio_num_t touch_interrupt_default =
      static_cast<gpio_num_t>(CONFIG_ESP32_P4_WIFI6_DEV_KIT_TOUCH_INTERRUPT_GPIO);
#else
